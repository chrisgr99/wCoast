// Generator for the Quad Function Generator v2 faceplate — the original 281t
...
const CH = ['A', 'B', 'C', 'D'];
const FACE_W = 98, FACE_H = 113.5912, FACE_LEFT = 3.9, FACE_TOP = 7.0994;

const COL_TRIG = 10, COL_CYCLE = 19, COL_ACV = 28, COL_ATK = 39,
  COL_DCV = 50, COL_DEC = 61, COL_OUT = 73, COL_LED = 79;
const DIVIDER_X = 82;
const Q_KNOB_X = 90;
...
console.log('wrote function-gen-281t-v2 panel.svg + panel.dark.svg');
